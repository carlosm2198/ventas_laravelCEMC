...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    <a class="navbar-brand" target="_blank" href="">TU TIENDA EN LINEA</a>
    ...
    <div class="collapse navbar-collapse" id="menu">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            @endauth
            <li class="nav-item">
                <a class="nav-link" href="{{route("soporte.index")}}">&nbsp;<i
                        class="fa fa-hands-helping"></i></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route("acerca_de.index")}}">&nbsp;<i class="fa fa-info"></i></a>
            </li>
        </ul>
    </div>
</nav>
...
<footer class="px-2 py-2 fixed-bottom bg-dark">
    <span class="text-muted">Punto de venta 
        ...
        <a class="text-white" href="//parzibyte.me/blog">CARLOS EDUARDO MUÑOZ CRUZ</a>
        &nbsp;|&nbsp;
